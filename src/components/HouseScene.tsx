  ...
  const renderStageDecorations = () => {
    switch (stageIndex) {
      case 0:
        return (
          <g>
            <rect x="220" y="280" width="8" height="60" fill="#888" />
            <rect x="235" y="290" width="6" height="50" fill="#777" />
            <rect x="250" y="285" width="7" height="55" fill="#999" />
            <text x="400" y="230" fontSize="14" fill="#6B6B6B" textAnchor="middle">毛坯空房</text>
          </g>
        );
      case 1:
        return (
          <g>
            <rect x="220" y="260" width="60" height="80" fill="#C4B8A8" opacity="0.6" />
            <rect x="520" y="270" width="50" height="70" fill="#B0A090" opacity="0.5" />
            <text x="250" y="310" fontSize="12" fill="#8B6F47">建材</text>
            <g transform="translate(300, 320)">
              <rect x="0" y="0" width="20" height="15" fill="#888" />
              <rect x="25" y="3" width="18" height="12" fill="#777" />
            </g>
      ...
      case 3:
        return (
          <g>
            <rect x="210" y="210" width="380" height="5" fill="#D4C4A8" />
            <line x1="210" y1="225" x2="590" y2="225" stroke="#C4B498" strokeWidth="1" />
            <line x1="210" y1="240" x2="590" y2="240" stroke="#C4B498" strokeWidth="1" />
            <g transform="translate(270, 200)">
              <rect x="0" y="0" width="40" height="8" fill="#FFF5E6" stroke="#E8D5B8" strokeWidth="1" />
              <rect x="5" y="-15" width="3" height="15" fill="#D4C4A8" />
              <rect x="32" y="-15" width="3" height="15" fill="#D4C4A8" />
            </g>
            <g transform="translate(450, 200)">
              <rect x="0" y="0" width="50" height="8" fill="#FFF5E6" stroke="#E8D5B8" strokeWidth="1" />
              <rect x="5" y="-18" width="3" height="18" fill="#D4C4A8" />
              <rect x="42" y="-18" width="3" height="18" fill="#D4C4A8" />
            </g>
        ...
        return (
          <g>
            ...
            <g transform="translate(510, 270)">
              <rect x="0" y="0" width="50" height="60" fill="#8B4513" stroke="#5A2A0A" strokeWidth="1.5" />
              <rect x="3" y="3" width="44" height="15" fill="#D4A574" />
              <rect x="3" y="22" width="44" height="15" fill="#D4A574" />
              <rect x="3" y="41" width="44" height="16" fill="#D4A574" />
        ...
        return (
          <g>
            ...
            <g transform="translate(300, 315)">
              <circle cx="0" cy="0" r="6" fill="#C84A3E" />
              <rect x="-1.5" y="5" width="3" height="10" fill="#8B6F47" />
            </g>
            <g transform="translate(480, 320)">
              <rect x="-4" y="0" width="8" height="3" fill="#C84A3E" />
              <rect x="-2" y="3" width="4" height="8" fill="#FFD700" />
            </g>
